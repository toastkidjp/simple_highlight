 ...
 * @author Toast kid
 */
public class KotlinHighlighter extends Highlighter {

    private static final String PATH_TO_KEYWORDS  = "keywords/kotlin.txt";
     ...
     * @param codeArea
     */
    public KotlinHighlighter(final CodeArea codeArea) {
        super(codeArea);
    }
