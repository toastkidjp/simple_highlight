 ...
 * @author Toast kid
 */
public class GroovyHighlighter extends Highlighter {

    private static final String PATH_TO_KEYWORDS  = "keywords/groovy.txt";
     ...
     * @param codeArea
     */
    public GroovyHighlighter(final CodeArea codeArea) {
        super(codeArea);
    }
