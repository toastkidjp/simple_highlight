 ...
 * @author Toast kid
 */
public class JavaScriptHighlighter extends Highlighter {

    private static final String PATH_TO_KEYWORDS  = "keywords/js.txt";
     ...
     * @param codeArea
     */
    public JavaScriptHighlighter(final CodeArea codeArea) {
        super(codeArea);
    }
